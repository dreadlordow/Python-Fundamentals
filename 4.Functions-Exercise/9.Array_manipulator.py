...
def get_index_max_even_numb(numbers):
    max_num = -sys.maxsize
    index = -1
...
def get_index_max_odd_numb(numbers):
    max_num = -sys.maxsize
    index = -1
...
def get_index_min_even_numb(numbers):
    min_num = sys.maxsize
    index = -1
...
def get_index_min_odd_numb(numbers):
    min_num = sys.maxsize
    index = -1
...
while command_input != 'end':
    ...
    if command == 'exchange':
        ...
        if criteria == 'even':
            index = get_index_max_even_numb(numbers)
        elif criteria == 'odd':
            index = get_index_max_odd_numb(numbers)
        if index != - 1:
            print(index)
        else:
            print('No matches')
        ...
        if criteria == 'even':
            index = get_index_min_even_numb(numbers)
        elif criteria == 'odd':
            index = get_index_min_odd_numb(numbers)
